...
<html>
    ...
    <body>
        ...
        <%
            ...
            PreparedStatement st=cn.prepareStatement("select count(*) from student");
       ...
       <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="StudentProfile.jsp" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i>Welcome  <%=n%>
                            </a>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><%=coun%></h3>
                                <p class="fs-7">REGISTERED STUDENTS</p>
                            </div>
                            <i
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">19</h3>
                                <p class="fs-7">TOTAL DRIVE POSTS</p>
                            </div>
                            <i class="fas fa-brands fa-red-river fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">%25</h3>
                                <p class="fs-7">TOTAL APPLICATION </p>
                            </div>
